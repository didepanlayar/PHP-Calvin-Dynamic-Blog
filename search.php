<?php
    ...
    if (isset($_REQUEST['query'])) {
        ...
        $sqlGetSearchQuery = "SELECT * FROM tags INNER JOIN posts ON tags.post_id = posts.post_id WHERE tags.tag LIKE '%" . $searchQuery . "%' OR posts.post_title LIKE '%" . $searchQuery . "%'";
        $queryGetSearchQuery = mysqli_query($connect, $sqlGetSearchQuery);
?>
<!DOCTYPE html>
<html class="no-js" lang="en">
<head>
    <meta charset="utf-8">
    <title>Calvin - Search</title>
        ...
        <div class="s-pageheader">
            <div class="row">
                <div class="column large-12">
                    <h1 class="page-title">
                        <span class="page-title__small-type">Search Result</span>
        ...
        <div class="s-bricks s-bricks--half-top-padding">
            <div class="masonry">
                <div class="bricks-wrapper h-group">
                    ...
                    <?php
                        while ($rowGetAllSearch = mysqli_fetch_assoc($queryGetSearchQuery)) {
                            $postTitle = $rowGetAllSearch['post_title'];
                            $postSlug = $rowGetAllSearch['post_url'];
                            $postSummary = $rowGetAllSearch['post_summary'];
                            $postAltImage = $rowGetAllSearch['alt_image_url'];
                    ?>
